export default function SkillsSection() {
    return (
        <section className="p-4 flex items-center justify-center px-6">
            <div className="max-w-3xl text-center">
                ...
                <div className="mt-8 space-y-6 text-left">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold">Docker</h3>
                        <p className="mt-2">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold ">Azure / AWS</h3>
                        <p className="mt-2">
